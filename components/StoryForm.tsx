...
import { Card, Button, Input, Select, SectionHeader } from './ui';
import { BlueprintSelector } from './BlueprintSelector';
import { AccessibilityPanel } from './AccessibilityPanel';

interface StoryFormProps {
  /** Full profile or partial (e.g. quick-start name only). */
...
export const StoryForm: React.FC<StoryFormProps> = ({
  ...
  const [gender, setGender] = useState<ChildGender>(profile?.gender || 'neutral');
        ...
        <div className="space-y-4 p-4 bg-slate-900/40 rounded-2xl border border-slate-700/30">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <Select
              ...
              value={gender}
              onChange={(e) =>
                setGender(e.target.value as ChildGender)
              }
              options={[
